    ...
    def users_input(self):
        ...
        u_input_list = [hour, temperature, humidity, wind_speed, visibility, \
                        solar_radiation, rainfall, snowfall, holiday_dic[holiday], \
                            functioning_dic[functioning_day],
...
if __name__ == "__main__":
    ...
    ml_model_path = r"C:\seoul_bike_sharing_demand_prediction\models\xgboost_regressor_r2_0_946_v1.pkl"
    standard_scaler_path = r"C:\seoul_bike_sharing_demand_prediction\models\sc.pkl"
